  ...
  return (
    <div className='mobile-landscape:col-start-2 mobile-portrait:row-start-2'>
      <Sheet open={value} onOpenChange={toggle}>
        <SheetContent
          side='bottom'
          className='mobile-landscape:px-safe mobile-landscape:h-full h-[80vh] gap-3 overflow-y-scroll py-3'
        >
        ...
        <nav className='mobile-landscape:h-full mobile-landscape:pr-safe grad-border bg-background mobile-landscape:grid-flow-row mobile-portrait:border-t-2 mobile-landscape:border-l-2 grid grid-flow-col items-center justify-between justify-items-stretch p-4'>
          <h1 className='mobile-landscape:justify-self-center mobile-landscape:self-start mobile-portrait:col-span-4 text-left'>
            AV
          </h1>
